...
# Sunnify - Redesigned UI
# Dark theme: Negro + Verde Spotify (#1DB954)
# Ventana: 825x550 (+10% sobre 750x500 original)
# Sin transparencia, sin degradado
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # ══════════════════════════════════════════════════════════════════════
        # PANEL IZQUIERDO  352 x 506  (original 320x460 +10%)
        # Posición: x=33, y=22  (original 30,20 +10%)
        # ══════════════════════════════════════════════════════════════════════
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(22, 275, 308, 28))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(22, 308, 308, 28))
        ...
        # ── Fila: Time  +  cronómetro ──────────────────────────────────────────
        self.horizontalLayoutWidget_time = QtWidgets.QWidget(self.frame)
        self.horizontalLayoutWidget_time.setGeometry(QtCore.QRect(22, 341, 308, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Closed.setText(_translate("MainWindow", "✕"))
        ...
        self.CounterLabel.setText(_translate("MainWindow", "0"))
        ...
        self.label_6.setText(_translate("MainWindow",
            "<html><head/><body><p align=\"right\">Released :</p></body></html>"))
        self.label_11.setText(_translate("MainWindow",
            "<html><head/><body><p align=\"right\">Artist :</p></body></html>"))
        self.label_8.setText(_translate("MainWindow",
            "<html><head/><body><p align=\"right\">Album :</p></body></html>"))
        self.YearText.setText(_translate("MainWindow",
            "<html><head/><body><p><br/></p></body></html>"))
        self.ArtistNameText.setText(_translate("MainWindow",
            "<html><head/><body><p><br/></p></body></html>"))
        self.AlbumText.setText(_translate("MainWindow",
            "<html><head/><body><p><br/></p></body></html>"))
        self.SongName.setText(_translate("MainWindow",
            "<html><head/><body><p><br/></p></body></html>"))
        self.label_9.setText(_translate("MainWindow",
            "<html><head/><body><p align=\"right\">Song :</p></body></html>"))